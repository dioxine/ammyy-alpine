...
> [!IMPORTANT]
> Для установки системных зависимостей и настройки служб OpenRC требуются права суперпользователя. Убедитесь, что вы запущены под учетной записью `root` или используете `sudo`.
